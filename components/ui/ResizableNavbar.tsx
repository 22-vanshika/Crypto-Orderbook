...
const EXCHANGES = ["Bybit", "Deribit","OKX"] as const;
        ...
        <div className="flex items-center gap-6">
          {EXCHANGES.map((exchange) => (
            <button
              ...
              className={`relative inline-flex h-9 items-center justify-center rounded-2xl px-4 py-1 text-sm font-medium transition-all shadow shadow-amber-100/20
              ${activeExchange === exchange
                  ? "bg-amber-200/10  font-semibold"
        ...
        <MobileNavMenu isOpen={isOpen} onClose={() => setIsOpen(false)}>
          {EXCHANGES.map((exchange) => (
            <button
              ...
              className={`relative w-full text-left inline-flex h-10 items-center justify-start rounded-2xl px-4 py-1 text-sm font-medium transition-all  mb-2 shadow shadow-amber-100/20
                ${activeExchange === exchange
                  ? "bg-amber-200/10  font-semibold"
            ...
            >
              <span className="absolute inset-0 rounded-full border border-white/30 backdrop-blur-xl" />
              <span className="relative z-10">{exchange}</span>
            </button>
          ))}
